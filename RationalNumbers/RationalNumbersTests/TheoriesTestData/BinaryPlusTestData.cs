...
{
    public class BinaryPlusTestData : IEnumerable<object[]>
    {
        private readonly List<object[]> _data = new()
        {
            ...
            new object[] { new Rational( -11, 22 ), new Rational( 1, 3 ), new Rational( -1, 6 ) },
            new object[] { new Rational( -3, 7 ), 2, new Rational( 11, 7 ) },
            new object[] { 2, new Rational( -3, 7 ), new Rational( 11, 7 ) },
